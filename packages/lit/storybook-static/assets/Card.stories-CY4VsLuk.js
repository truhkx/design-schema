import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{_ as t,b as n,w as r}from"./if-defined-CARySXJh.js";import{t as i}from"./Text-b_nq3K9L.js";import{t as a}from"./Button-B3rVveNU.js";import{t as o}from"./Link-CzFgI_Cj.js";import{t as s}from"./Card-C9kTAJKf.js";var c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O,k,A,j;function M(){return(M=e((()=>{t(),s(),i(),a(),o(),c={title:`Card/Lit`,tags:[`autodocs`],argTypes:{headingLevel:{control:`select`,options:[`2`,`3`,`4`,`5`,`6`]},inset:{control:`select`,options:[`sm`,`md`,`lg`]},surface:{control:`select`,options:[`default`,`subtle`]},interactive:{control:`boolean`},focusable:{control:`boolean`},footer:{control:`boolean`}},args:{heading:`Team plan`,headingLevel:`3`,inset:`md`,surface:`default`,interactive:!1,focusable:!1,children:`What the plan includes`,footer:!1},render:e=>r`
  ...
  `},E={args:{heading:`September invoice`,interactive:!0,children:`Nothing here is a link, so the card is not a target.`},render:e=>r`
    <div style="inline-size: min(100%, 24rem)">
      <ds-card heading=${e.heading} heading-level=${e.headingLevel} inset=${e.inset} surface=${e.surface} interactive>
        <ds-text element="p">${e.children}</ds-text>
      </ds-card>
    </div>
  `},D={args:{heading:`Team plan`,headingLevel:`3`,children:`What the plan includes`}},O={args:{heading:``,children:`A search result`,inset:`sm`,surface:`subtle`}},k={args:{heading:`September invoice`,children:`A Link to the invoice`,interactive:!0}},A={args:{heading:`New comment`,children:`The comment body`,focusable:!0}},j=[`Default`,`HeadingLevel2`,`HeadingLevel3`,`HeadingLevel4`,`HeadingLevel5`,`HeadingLevel6`,`InsetSm`,`InsetMd`,`InsetLg`,`SurfaceDefault`,`SurfaceSubtle`,`WithHeaderActions`,`Interactive`,`InteractiveSubtle`,`InteractiveWithText`,`InteractiveInFragment`,`InteractiveDisabledButton`,`InteractiveWithoutTarget`,`PlanCard`,`DenseGridCard`,`WholeCardIsALink`,`CardFocusedByAFeed`],l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  args: {
    footer: true
  }
...
}`,...A.parameters?.docs?.source}}}})))()}M();export{A as CardFocusedByAFeed,l as Default,O as DenseGridCard,u as HeadingLevel2,d as HeadingLevel3,f as HeadingLevel4,p as HeadingLevel5,m as HeadingLevel6,_ as InsetLg,g as InsetMd,h as InsetSm,x as Interactive,T as InteractiveDisabledButton,w as InteractiveInFragment,S as InteractiveSubtle,C as InteractiveWithText,E as InteractiveWithoutTarget,D as PlanCard,v as SurfaceDefault,y as SurfaceSubtle,k as WholeCardIsALink,b as WithHeaderActions,j as __namedExportsOrder,c as default};