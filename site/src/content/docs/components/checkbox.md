...
component:
  ...
  styles:
    ...
    indicator: { token: color.control.selectedForeground, description: 'The check mark and the mixed dash, drawn in this color inside a box of controlSize minus 2 × space.1.' }
