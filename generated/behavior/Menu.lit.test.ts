...
async function setup(given: Record<string, unknown> = {}) {
  ...
  const s = {
    ...
    props,
    root_: () => el,
    trigger: () => ((el.matches('[role="menu"]') ? el : null) ?? deep(root, '[role="menu"]') ?? (el.matches('[part~="trigger"], [data-part="trigger"]') ? el : null) ?? deep(root, '[part="trigger"]') ?? deep(root, '[data-part="trigger"]') ?? root.firstElementChild) as HTMLElement,
    item: () => ((el.matches('[part~="item"], [data-part="item"]') ? el : null) ?? deep(root, '[part="item"]') ?? deep(root, '[data-part="item"]')) as HTMLElement,
  };
  return s;
}
...
describe('ds-menu', () => {
  test('choosing-an-item-reports-the-action-and-the-close', async () => {
    ...
    await userEvent.click(located(activatable(s.item(), s.el)), { force: true });
  ...
  test('the-popup-is-a-menu', async () => {
    ...
    expect(s.el.matches('[role="menu"]') || deep(s.root, '[role="menu"]') !== null || deep(s.el, '[role="menu"]') !== null).toBe(true);
  });
  test('renders', async () => {
  ...
  test('has-accessible-name', async () => {
    ...
    else expect(s.trigger()).toHaveAccessibleName(s.props.label);
  });
