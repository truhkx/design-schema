// Generated by tools/keyboard_tests.ts from the `keyboard` block of the Search doc. Do not edit.
...
test.describe('Search (web) keyboard', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('/iframe.html?id=search-react--keyboard&viewMode=story');
  ...
  test('Tab: Leaves the field: to the clear button when the field has text, then the submit button.', async ({ page }) => {
    const root = await subject(page, page.locator('[data-ds="Search"]').first());
