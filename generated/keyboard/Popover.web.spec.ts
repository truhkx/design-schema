// Generated by tools/keyboard_tests.ts from the `keyboard` block of the Popover doc. Do not edit.
...
test.describe('Popover (web) keyboard', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('/iframe.html?id=popover-react--keyboard&viewMode=story');
  ...
  test('Escape: Closes and returns focus to the trigger. (open)', async ({ page }) => {
  ...
  test('Tab: Non-modal: after the last element in the panel, closes and moves focus to the element after the trigger. Modal: wraps within the panel. (open)', async ({ page }) => {
    await page.goto('/iframe.html?id=popover-react--keyboard&viewMode=story&args=modal:!false');
    await expect(page.getByRole('dialog').first()).toBeVisible({ timeout: 15_000 });
    const root = await subject(page, page.getByRole('dialog').first());
