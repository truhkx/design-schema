import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{_ as t,r as n,t as r,w as i}from"./if-defined-CARySXJh.js";import{t as a}from"./Button-B3rVveNU.js";import{t as o}from"./Stack-CZci_zJ9.js";import{t as s}from"./Box-Cbe3zAzP.js";import{i as c}from"./iframe-C6sywzE2.js";var l,u,d,f,p,m,h,g,_,v,y,b,x,S,C;function w(){return(w=e((()=>{t(),r(),c(),s(),a(),o(),l={title:`Splitter/Lit`,tags:[`autodocs`],parameters:{actions:{handles:[`size-change`,`size-change-end`,`collapse-change`]}},argTypes:{orientation:{control:`select`,options:[`horizontal`,`vertical`]},stackBelow:{control:`select`,options:[`prose`,`content`,`never`]},collapsible:{control:`boolean`},defaultCollapsed:{control:`boolean`}},args:{label:`Sidebar width`,primary:`A navigation tree`,secondary:`The selected document`,orientation:`horizontal`,defaultSize:30,minSize:10,maxSize:90,step:2,collapsible:!1,defaultCollapsed:!1,persistKey:void 0,stackBelow:`prose`},render:e=>i`
    <div
