...
test.describe('AlertDialog (web) keyboard', () => {
  ...
  test('Escape: Cancels (onCancel with reason escape).', async ({ page }) => {
    const root = await subject(page, page.getByRole('alertdialog').first());
