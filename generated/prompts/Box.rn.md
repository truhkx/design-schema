...
notes: "View with paddingVertical/paddingHorizontal, backgroundColor, borderWidth/borderColor,\
  ...
  \ is illustrative; native requires it inside a Text. Resolved overrides are cast\
  \ to the binding's own type: number for padding, width and radius, string for the\
  \ border colour."
```
