import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{f as t}from"./iframe-D5pPePpr.js";import{t as n}from"./jsx-runtime-DeHZSEgm.js";import{n as r,t as i}from"./names-szlHjJ4U.js";import{n as a,t as o}from"./Text-B1hFPUay.js";import{n as s,t as c}from"./Icon-dvwZzeX-.js";function l(e){let t={},n={fontSize:_.labelSize,fontWeight:_.labelWeight,fontFamily:_.fontFamily},r={fontSize:_.labelSize,fontWeight:_.labelCurrentWeight,fontFamily:_.fontFamily},a={fontSize:_.descriptionSize,fontFamily:_.fontFamily},o={fontSize:_.countSize,fontFamily:_.fontFamily},s=_.indicatorFontSize;for(let c of Object.keys(e??{})){let l=e?.[c],u=g[c];if(l)switch(u&&(t[u]=i(l)),c){case`labelSize`:n.fontSize=l,r.fontSize=l;break;case`labelWeight`:n.fontWeight=l;break;case`labelCurrentWeight`:r.fontWeight=l;break;case`descriptionSize`:a.fontSize=l;break;case`countSize`:o.fontSize=l;break;case`indicatorFontSize`:s=l;break;case`fontFamily`:n.fontFamily=l,r.fontFamily=l,a.fontFamily=l,o.fontFamily=l}}return{rootStyle:Object.keys(t).length>0?t:void 0,label:n,currentLabel:r,description:a,count:o,indicatorFontSize:s}}function u(e,t,n){return e.status?e.status:n===-1||t>n?`upcoming`:t<n?`complete`:`current`}function d({ref:e,label:t,steps:n,current:r,orientation:i=`horizontal`,navigable:a=`completed`,compact:s=!1,overrides:d,onStepSelect:g,...y}){let b=(0,f.useId)(),x=n.findIndex(e=>e.id===r),S=Math.max(x,0),C=l(d);(0,f.useEffect)(()=>{h&&r!==``&&x===-1&&console.warn(`Stepper: current "${r}" matches no step id; nothing is selected.`)},[r,x]);let w=[`ds-stepper`,`ds-stepper--${i}`,s&&i===`horizontal`?`ds-stepper--compact`:null].filter(Boolean).join(` `),T=m.stepOf.replace(`{current}`,String(S+1)).replace(`{total}`,String(n.length));return(0,p.jsxs)(`nav`,{...y,ref:e,"data-ds":`Stepper`,className:w,style:C.rootStyle,"aria-label":t||m.navLabel,children:[(0,p.jsx)(`ol`,{className:`ds-stepper__list`,"data-part":`list`,children:n.map((e,t)=>{let r=u(e,t,x),s=t===x,l=x!==-1&&t<x,d=a===`all`||a===`completed`&&l,f=v[r],m=i===`vertical`&&e.description!==void 0&&e.description!==``,h=m&&d?`${b}-d${t}`:void 0,y=t===n.length-1,w=e=>({size:C.indicatorFontSize,color:e}),T=(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(`span`,{className:`ds-stepper__indicator`,"data-part":`indicator`,"aria-hidden":`true`,children:r===`complete`?(0,p.jsx)(c,{name:`check`,size:`sm`,overrides:w(_.indicatorCompleteForeground)}):r===`error`?(0,p.jsx)(c,{name:`danger`,size:`sm`,overrides:w(_.indicatorErrorForeground)}):t+1}),(0,p.jsxs)(`span`,{className:`ds-stepper__content`,children:[(0,p.jsx)(o,{element:`span`,size:`sm`,tone:r===`upcoming`?`muted`:`default`,align:i===`horizontal`?`center`:`start`,"data-part":`label`,overrides:s?C.currentLabel:C.label,children:e.label}),f?(0,p.jsx)(`span`,{className:`ds-stepper__visually-hidden`,children:`, ${f}`}):null,m?(0,p.jsx)(o,{element:`span`,size:`xs`,tone:`muted`,id:h,"aria-hidden":h?`true`:void 0,"data-part":`description`,overrides:C.description,children:e.description}):null]})]});return(0,p.jsxs)(`li`,{className:[`ds-stepper__step`,`ds-stepper__step--${r}`,s?`ds-stepper__step--selected`:null,t===S?`ds-stepper__step--revealed`:null].filter(Boolean).join(` `),"data-part":`step`,children:[d?(0,p.jsx)(`button`,{type:`button`,className:`ds-stepper__control ds-stepper__control--navigable`,"aria-current":s?`step`:void 0,"aria-describedby":h,onClick:()=>g?.(e.id),children:T}):(0,p.jsx)(`div`,{className:`ds-stepper__control`,"aria-current":s?`step`:void 0,children:T}),y?null:(0,p.jsx)(`span`,{className:`ds-stepper__connector${l?` ds-stepper__connector--complete`:``}`,"data-part":`connector`,"aria-hidden":`true`})]},e.id)})}),(0,p.jsx)(o,{element:`span`,size:`sm`,tone:`muted`,className:`ds-stepper__count`,"data-part":`count`,overrides:C.count,children:T})]})}var f,p,m,h,g,_,v;function y(){return(y=e((()=>{f=t(),r(),a(),s(),p=n(),m={navLabel:`Progress`,stepOf:`Step {current} of {total}`,complete:`completed`,current:`current step`,error:`has an error`,stepLabel:`Step {n}: {label}`},h=typeof process<`u`&&!1,g={indicatorSize:`--ds-stepper-indicator-size`,indicatorBackground:`--ds-stepper-indicator-background`,indicatorRadius:`--ds-stepper-indicator-radius`,indicatorFontSize:`--ds-stepper-indicator-font-size`,indicatorFontWeight:`--ds-stepper-indicator-font-weight`,connector:`--ds-stepper-connector`,stepHover:`--ds-stepper-step-hover`,stepRadius:`--ds-stepper-step-radius`,stepPadding:`--ds-stepper-step-padding`,stepGap:`--ds-stepper-step-gap`,partGap:`--ds-stepper-part-gap`,fontFamily:`--ds-stepper-font-family`,transition:`--ds-stepper-transition`},_={labelSize:`font.size.sm`,labelWeight:`font.weight.medium`,labelCurrentWeight:`font.weight.semibold`,descriptionSize:`font.size.xs`,countSize:`font.size.sm`,fontFamily:`font.family.body`,indicatorFontSize:`font.size.sm`,indicatorCompleteForeground:`color.control.selectedForeground`,indicatorErrorForeground:`color.status.danger.foreground`},v={complete:m.complete,current:m.current,error:m.error,upcoming:void 0},d.__docgenInfo={description:`Stepper — Design Schema, category: navigation.\r
\r
When to use:\r
Use a Stepper for a flow with three to about seven ordered steps that each fit on a screen: checkout, account setup, a report builder, a multi-part application. Vertical with descriptions for flows that need explanation ("Verify your identity — takes about 2 minutes"); horizontal for short, familiar ones. Leave \`navigable: completed\` so people can correct earlier answers without losing later ones (the container keeps the later steps' state).`,methods:[],displayName:`Stepper`,props:{label:{required:!1,tsType:{name:`union`,raw:`string | undefined`,elements:[{name:`string`},{name:`undefined`}]},description:"Accessible name of the navigation landmark. Defaults to `copy.navLabel`."},steps:{required:!0,tsType:{name:`Array`,elements:[{name:`signature`,type:`object`,raw:`{ id: string; label: string; description?: string; status?: "complete" | "current" | "upcoming" | "error" }`,signature:{properties:[{key:`id`,value:{name:`string`,required:!0}},{key:`label`,value:{name:`string`,required:!0}},{key:`description`,value:{name:`string`,required:!1}},{key:`status`,value:{name:`union`,raw:`"complete" | "current" | "upcoming" | "error"`,elements:[{name:`literal`,value:`"complete"`},{name:`literal`,value:`"current"`},{name:`literal`,value:`"upcoming"`},{name:`literal`,value:`"error"`}],required:!1}}]}}],raw:`{ id: string; label: string; description?: string; status?: "complete" | "current" | "upcoming" | "error" }[]`},description:"The steps in order. `status` is derived from `current` when omitted: before it complete, the step it\r\nnames current, after it upcoming. An explicit `status` sets only the indicator, its colours and the\r\nstatus word; position (not status) decides the selected state, navigability, the connector colour and\r\nthe compact reveal."},current:{required:!0,tsType:{name:`string`},description:'The id of the current step. The step whose id matches is the selected one (`aria-current="step"`) and\r\nthe one compact reveals, whatever its `status`. When no id matches, nothing is selected, every step\r\nwithout an explicit status is upcoming, no step is navigable under `completed` (all still are under\r\n`all`), the count reads "Step 1 of m", and development builds log a warning. The warning needs a\r\nnon-empty `current`: an empty one is treated as not yet set and does not warn.'},orientation:{required:!1,tsType:{name:`union`,raw:`StepperOrientation | undefined`,elements:[{name:`union`,raw:`'horizontal' | 'vertical'`,elements:[{name:`literal`,value:`'horizontal'`},{name:`literal`,value:`'vertical'`}]},{name:`undefined`}]},description:"Vertical shows descriptions under each label and suits a side column; horizontal does not render\r\ndescriptions at all (not clipped, and no aria-describedby) and collapses to `compact` below the prose width.",defaultValue:{value:`'horizontal'`,computed:!1}},navigable:{required:!1,tsType:{name:`union`,raw:`StepperNavigable | undefined`,elements:[{name:`union`,raw:`'none' | 'completed' | 'all'`,elements:[{name:`literal`,value:`'none'`},{name:`literal`,value:`'completed'`},{name:`literal`,value:`'all'`}]},{name:`undefined`}]},description:`Which steps can be activated: none (display only), completed steps (the usual — you can go back,\r
not skip ahead), or all (a settings-style flow where order does not matter). "Completed" means\r
...
hand or automatically below the prose width — a vertical stepper has the room, so the prop does nothing\r
there. The other steps' labels, with their status words, are visually clipped, not removed.`,defaultValue:{value:`false`,computed:!1}},overrides:{required:!1,tsType:{name:`union`,raw:`Partial<Record<StepperOverridableBinding, TokenRef | undefined>> | undefined`,elements:[{name:`Partial`,elements:[{name:`Record`,elements:[{name:`union`,raw:`| 'indicatorSize'\r
| 'indicatorBackground'\r
| 'indicatorRadius'\r
| 'indicatorFontSize'\r
| 'indicatorFontWeight'\r
| 'connector'\r
| 'labelWeight'\r
| 'labelCurrentWeight'\r
| 'labelSize'\r
| 'descriptionSize'\r
| 'countSize'\r
| 'stepHover'\r
