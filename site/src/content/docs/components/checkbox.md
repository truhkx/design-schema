...
component:
  ...
  styles:
    ...
    helperSize: { token: font.size.sm, part: description, description: 'Description and error text size. Reaches the composed Texts only through their `fontSize` override, with fontFamily and lineHeight forwarded the same way; no --ds-checkbox-* hook.' }
