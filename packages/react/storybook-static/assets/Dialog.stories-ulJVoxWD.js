...
}`,...M.parameters?.docs?.source},description:{story:`Open with its trigger and more than three focusable children, for the keyboard gate.`,...M.parameters?.docs?.description}}},N.parameters={...N.parameters,docs:{...N.parameters?.docs,source:{originalSource:`{
  args: {
    open: true,
...
}`,...I.parameters?.docs?.source}}}})))()}R();export{j as Closed,S as Default,k as HideHeading,O as InitialFocusClose,E as InitialFocusFirst,D as InitialFocusTitle,P as InvitePeople,M as Keyboard,F as MustBeAnswered,A as NotDismissible,I as ReadingDialog,N as RenameProject,T as SizeLg,w as SizeMd,C as SizeSm,L as __namedExportsOrder,x as default};