import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{_ as t,w as n}from"./if-defined-CARySXJh.js";import{E as r}from"./iframe-B0T1LYjz.js";var i,a,o,s,c,l,u;function d(){return(d=e((()=>{t(),r(),i={title:`Breadcrumb/Lit`,tags:[`autodocs`],parameters:{actions:{handles:[`navigate`]}},argTypes:{collapse:{control:`boolean`}},args:{items:[{label:`Docs`,href:`/docs`},{label:`Components`,href:`/docs/components`},{label:`Breadcrumb`}],label:`Breadcrumb`,collapse:!0},render:e=>n`
    <ds-breadcrumb
      .items=${e.items}
      label=${e.label}
