...
component:
  ...
  composition:
    item: { component: Disclosure, props: { fullWidth: true }, forwards: { triggerPaddingBlock: triggerPaddingBlock, fontFamily: triggerFontFamily, triggerFontSize: triggerFontSize, triggerFontWeight: triggerFontWeight } }
  props:
    items:
      type: array
      required: true
