import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{f as t}from"./iframe-BaAix2rE.js";import{t as n}from"./jsx-runtime-DeHZSEgm.js";import{n as r,t as i}from"./names-szlHjJ4U.js";import{n as a,t as o}from"./Button-CXwJSRqr.js";import{n as s,t as c}from"./Text-BmznDQS2.js";import{n as l,t as u}from"./Link-DHkk5TA_.js";import{n as d,t as f}from"./Stack-CGf5Bw3v.js";import{n as p,t as m}from"./Card-CDWzeK5i.js";import{n as h,t as g}from"./ProgressBar-faoIulj6.js";function _(e){if(!e)return{rootStyle:void 0,card:void 0,articleBody:void 0,timestamp:void 0,endMessage:void 0,emptyState:void 0,newItemsButton:void 0};let t={},n={},r={},a={},o={},s={},c={};for(let l of Object.keys(e)){let u=e[l];if(!u)continue;let d=T[l];switch(d&&(t[d]=i(u)),l){case`articleInset`:n.paddingBlock=u,n.paddingInline=u;break;case`articleBodyGap`:r.gap=u;break;case`timestampSize`:a.fontSize=u;break;case`endMessageSize`:o.fontSize=u;break;case`emptyStateSize`:s.fontSize=u;break;case`fontFamily`:a.fontFamily=u,o.fontFamily=u,s.fontFamily=u,c.fontFamily=u}}return{rootStyle:t,card:n,articleBody:r,timestamp:a,endMessage:o,emptyState:s,newItemsButton:c}}function v(e,t){let n=new Date(e).getTime();if(Number.isNaN(n))return e;let r=Math.max(0,t-n);return r<O?w.justNow:r<k?w.minutesAgo.replace(`{n}`,String(Math.floor(r/O))):r<A?w.hoursAgo.replace(`{n}`,String(Math.floor(r/k))):r<j*A?w.daysAgo.replace(`{n}`,String(Math.floor(r/A))):new Intl.DateTimeFormat(void 0,{dateStyle:`medium`}).format(n)}function y(e){let t=new Date(e).getTime();if(!Number.isNaN(t))return new Intl.DateTimeFormat(void 0,{dateStyle:`medium`,timeStyle:`short`}).format(t)}function b(e){return Array.from(e.ownerDocument.querySelectorAll(N)).filter(t=>!e.contains(t)&&!t.closest(`[inert]`))}function x(){return typeof window<`u`&&typeof window.matchMedia==`function`&&window.matchMedia(`(prefers-reduced-motion: reduce)`).matches}var S,C,w,T,E,D,O,k,A,j,M,N,P;function F(){return(F=e((()=>{S=t(),r(),a(),p(),h(),d(),s(),C=n(),w={showNew:`Show {count} new`,loading:`Loading more`,end:`You are all caught up.`,unread:`unread`,position:`{index} of {total}`,empty:`Nothing here yet.`,justNow:`just now`,minutesAgo:`{n} min ago`,hoursAgo:`{n} hr ago`,daysAgo:`{n} d ago`},T={itemGap:`--ds-feed-item-gap`,newItemsOffset:`--ds-feed-new-items-offset`,newItemsLayer:`--ds-feed-new-items-layer`,loadingInset:`--ds-feed-loading-inset`,endMessageInset:`--ds-feed-end-message-inset`,emptyStateInset:`--ds-feed-empty-state-inset`,fontFamily:`--ds-feed-font-family`},E=typeof process<`u`&&!1,D=1e3,O=60*D,k=60*O,A=24*k,j=7,M=D,N=`a[href], button:not([disabled]), input:not([disabled]):not([type="hidden"]), select:not([disabled]), textarea:not([disabled]), [tabindex]:not([tabindex="-1"]), [contenteditable="true"]`,P=function({ref:e,label:t,items:n,hasMore:r=!1,loading:i=!1,newItemsCount:a,headingLevel:s=`3`,endMessage:l,onLoadMore:u,onShowNew:d,onItemVisible:p,overrides:h,onKeyDown:T,...D}){let O=`ds-feed${(0,S.useId)()}`,k=(0,S.useRef)(null),A=(0,S.useRef)(null);(0,S.useImperativeHandle)(e,()=>k.current,[]);let j=(0,S.useRef)(new Map),N=(0,S.useRef)(null),P=(0,S.useRef)(!1),F=E&&t.trim()===``;(0,S.useEffect)(()=>{F&&!P.current&&(P.current=!0,console.warn("Feed: `label` is the accessible name of the feed and must not be empty."))},[F]);let I=(0,S.useRef)(u),L=(0,S.useRef)(p);(0,S.useEffect)(()=>{I.current=u,L.current=p});let R=n.length,z=n[0]?.id,B=n[R-1]?.id,V=n.map(e=>e.id).join(` `),H=a!==void 0&&a>0,U=(0,S.useRef)(!1),W=(0,S.useRef)(z);(0,S.useEffect)(()=>{let e=W.current;if(W.current=z,!U.current||(U.current=!1,z===void 0||z===e))return;let t=j.current.get(z);t&&(t.focus({preventScroll:!0}),typeof t.scrollIntoView==`function`&&t.scrollIntoView({behavior:x()?`auto`:`smooth`,block:`start`}))},[V,z]);let G=(0,S.useRef)(!1);(0,S.useEffect)(()=>{R>0?G.current=!1:r&&!i&&!G.current&&(G.current=!0,I.current?.())},[R,r,i]),(0,S.useEffect)(()=>{if(!r||i||B===void 0||typeof IntersectionObserver>`u`)return;let e=j.current.get(B);if(!e)return;let t=!1,n=new IntersectionObserver(e=>{!t&&e.some(e=>e.isIntersecting)&&(t=!0,I.current?.())},{rootMargin:`100% 0px`});return n.observe(e),()=>n.disconnect()},[B,r,i]);let K=(0,S.useRef)(new Set);(0,S.useEffect)(()=>{if(typeof IntersectionObserver>`u`)return;let e=new Map,t=new Map;j.current.forEach((e,n)=>{K.current.has(n)||t.set(e,n)});let n=new IntersectionObserver(r=>{for(let i of r){let r=t.get(i.target);if(r===void 0)continue;let a=e.get(r);if(i.isIntersecting&&i.intersectionRatio>=.5){if(a!==void 0)continue;e.set(r,setTimeout(()=>{e.delete(r),!K.current.has(r)&&(K.current.add(r),n.unobserve(i.target),L.current?.(r))},M))}else a!==void 0&&(clearTimeout(a),e.delete(r))}},{threshold:.5});return t.forEach((e,t)=>n.observe(t)),()=>{n.disconnect(),e.forEach(e=>clearTimeout(e))}},[V]);let q=()=>{U.current=!0,d?.()},J=e=>{T?.(e);let t=k.current,n=A.current;if(e.defaultPrevented||!t||!n)return;let a=e.target.closest(`[role="article"]`);if(a&&a.closest(`[role="feed"]`)===n){if((e.key===`PageDown`||e.key===`PageUp`)&&!e.ctrlKey&&!e.altKey&&!e.metaKey){let t=Array.from(n.querySelectorAll(`[role="article"]`)).filter(e=>e.closest(`[role="feed"]`)===n),r=t.indexOf(a);e.preventDefault(),t[r+(e.key===`PageDown`?1:-1)]?.focus();return}if(e.key===`End`&&e.ctrlKey){e.preventDefault(),r?i||I.current?.():b(t).find(e=>(t.compareDocumentPosition(e)&Node.DOCUMENT_POSITION_FOLLOWING)!==0)?.focus();return}e.key===`Home`&&e.ctrlKey&&(e.preventDefault(),H&&N.current?N.current.focus():b(t).filter(e=>(t.compareDocumentPosition(e)&Node.DOCUMENT_POSITION_PRECEDING)!==0).pop()?.focus())}},Y=_(h),X=Date.now(),Z=!r,Q=R>0||i;return(0,C.jsxs)(`div`,{...D,ref:k,"data-ds":`Feed`,className:`ds-feed`,style:Y.rootStyle,onKeyDown:J,children:[(0,C.jsx)(`div`,{className:H?`ds-feed__new-items ds-feed__new-items--shown`:`ds-feed__new-items`,"data-part":H?`newItemsButton`:void 0,role:`status`,children:H?(0,C.jsx)(o,{ref:N,variant:`secondary`,size:`sm`,label:w.showNew.replace(`{count}`,String(a)),overrides:Y.newItemsButton,onClick:q}):null}),(0,C.jsxs)(`div`,{ref:A,className:`ds-feed__items`,"data-part":`container`,role:Q?`feed`:void 0,"aria-label":Q?t:void 0,"aria-busy":Q?i:void 0,children:[n.map((e,t)=>{let n=`${O}-${t}-time`,r=y(e.timestamp);return(0,C.jsx)(`div`,{className:e.unread?`ds-feed__item ds-feed__item--unread`:`ds-feed__item`,"data-part":`article`,children:(0,C.jsx)(m,{ref:t=>{t?j.current.set(e.id,t):j.current.delete(e.id)},focusable:!0,heading:e.heading,headingLevel:s,inset:`md`,overrides:Y.card,role:`article`,"aria-describedby":n,"aria-posinset":t+1,"aria-setsize":Z?R:-1,footer:e.actions!==void 0&&e.actions!==null?(0,C.jsx)(`div`,{className:`ds-feed__part`,"data-part":`articleActions`,children:(0,C.jsx)(f,{direction:`horizontal`,gap:`tight`,children:e.actions})}):void 0,children:(0,C.jsx)(`div`,{className:`ds-feed__part`,"data-part":`articleBody`,children:(0,C.jsxs)(f,{gap:`tight`,overrides:Y.articleBody,children:[e.unread?(0,C.jsx)(`span`,{className:`ds-feed__visually-hidden`,children:w.unread}):null,(0,C.jsx)(c,{element:`span`,tone:`muted`,size:`xs`,overrides:Y.timestamp,children:(0,C.jsx)(`time`,{id:n,"data-part":`timestamp`,dateTime:e.timestamp,title:r,children:v(e.timestamp,X)})}),Z?(0,C.jsx)(`span`,{className:`ds-feed__visually-hidden`,children:w.position.replace(`{index}`,String(t+1)).replace(`{total}`,String(R))}):null,e.content]})})})},e.id)}),!i&&R===0&&!r?(0,C.jsx)(`div`,{className:`ds-feed__empty-state`,"data-part":`emptyState`,children:(0,C.jsx)(c,{tone:`muted`,size:`sm`,overrides:Y.emptyState,children:w.empty})}):null,!i&&R>0&&!r?(0,C.jsx)(`div`,{className:`ds-feed__end-message`,"data-part":`endMessage`,children:(0,C.jsx)(c,{tone:`muted`,size:`sm`,overrides:Y.endMessage,children:l??w.end})}):null]}),i?(0,C.jsx)(`div`,{className:`ds-feed__loading`,"data-part":`loadingIndicator`,children:(0,C.jsx)(g,{label:w.loading,hideLabel:!0})}):null]})},P.__docgenInfo={description:"Feed — Design Schema, category: container.\n\nWhen to use:\nUse a Feed for a stream of similar, time-ordered items whose total is unknown or large: activity, notifications, comments, posts, audit events. Each item is a Card with a heading and a time. Use `newItemsCount` with `onShowNew` for live streams rather than inserting items while the reader is looking; use `onItemVisible` to mark things read.",methods:[],displayName:`Feed`,props:{label:{required:!0,tsType:{name:`string`},description:`What the feed contains ("Activity", "Notifications").`},items:{required:!0,tsType:{name:`Array`,elements:[{name:`signature`,type:`object`,raw:`{
  id: string;
  heading: string;
  timestamp: string;
  content: ReactNode;
