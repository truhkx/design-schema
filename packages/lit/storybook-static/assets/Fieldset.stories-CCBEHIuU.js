import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{_ as t,r as n,t as r,w as i}from"./if-defined-CARySXJh.js";import{t as a}from"./Input-DW6UoXDO.js";import{t as o}from"./Checkbox-3bTNXSrN.js";import{k as s}from"./iframe-CV6aZYyO.js";var c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D;function O(){return(O=e((()=>{t(),r(),s(),a(),o(),c=`An Input name=street label=Street and an Input name=city label=City`,l=`A required Input name=street label=Street and a required Input name=city label=City`,u=`A Checkbox name=email label=Email, a Checkbox name=sms label=SMS and a Checkbox name=push label=Push`,d=`An Input name=startDate label=Start date and an Input name=endDate label=End date`,f=()=>i`
