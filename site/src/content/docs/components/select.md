...
component:
  ...
  styles:
    ...
    fontWeight: { token: font.weight.regular, description: 'Weight of the trigger and option text. It exists as an override seam for composites that set their own header type — DatePicker forwards its monthTitleWeight into it.' }
