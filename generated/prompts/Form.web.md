...
notes: "Native submit semantics \u2014 Enter in a field submits, and a Button with\
  ...
  \ own (web and rn). The locked summary bindings (errorSummaryText, errorSummaryBackground,\
  \ errorSummaryBorder) get no `--ds-form-*` hook on web or Lit; their rules read\
  \ the token directly."
```
