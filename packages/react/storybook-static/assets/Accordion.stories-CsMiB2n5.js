import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{f as t}from"./iframe-C5klQxY3.js";import{t as n}from"./jsx-runtime-DeHZSEgm.js";import{n as r,t as i}from"./names-szlHjJ4U.js";import{n as a,t as o}from"./Text-B8ekB7A6.js";import{n as s,t as c}from"./Disclosure-9o2lWqvN.js";import{n as l,t as u}from"./Divider-DS0k_Pca.js";function d(e){if(e!==void 0)return Array.isArray(e)?e:e===``?[]:[e]}function f(e,t){return t&&e.length>1?e.slice(0,1):e}function p(e,t){return e.length===t.length&&e.every(e=>t.includes(e))}function m({ref:e,items:t,headingLevel:n=`3`,exclusive:r=!1,value:a,defaultValue:o,divided:s=!0,keepMounted:l=!1,overrides:m,onChange:v,onOpenChange:y,onKeyDown:b,...x}){let S=(0,h.useRef)(new Map),C=e=>t=>{t?S.current.set(e,t):S.current.delete(e)},w=a!==void 0,[T,E]=(0,h.useState)(()=>f(d(o)??[],r));!w&&r&&T.length>1&&E(T.slice(0,1));let D=f(w?d(a)??[]:T,r),O=w?JSON.stringify(d(a)??[]):null,k=d(w?a:o)??[],A=(0,h.useRef)(null);(0,h.useEffect)(()=>{if(!_||!r||k.length<=1)return;let e=k.join(` `);A.current!==e&&(A.current=e,console.warn(`Accordion: \`exclusive\` opens one section, but \`${w?`value`:`defaultValue`}\` has ${k.length} ids. Opening "${k[0]}"; ignoring ${k.slice(1).join(`, `)}.`))});let j=(0,h.useRef)({valueKey:O,openIds:D}),M=(0,h.useRef)(null);(0,h.useEffect)(()=>{let e=j.current;if(j.current={valueKey:O,openIds:D},!w){M.current=null;return}if(e.valueKey===O)return;let n=M.current;if(M.current=null,!(n!==null&&p(n,D)))for(let n of t){let t=e.openIds.includes(n.id),r=D.includes(n.id);t!==r&&y?.(n.id,r,`controlled`)}});let N=(e,n,i)=>{if(i===`controlled`)return;let a=D,o=n?r?[e]:a.includes(e)?a:[...a,e]:a.filter(t=>t!==e),s=i===`keyboard`?`keyboard`:`trigger`;if(w?M.current=o:E(o),v?.(o),y?.(e,n,s),n&&r)for(let n of t)n.id!==e&&a.includes(n.id)&&y?.(n.id,!1,`exclusive`)},P=e=>{if(b?.(e),e.defaultPrevented)return;let{key:n}=e;if(n!==`ArrowDown`&&n!==`ArrowUp`&&n!==`Home`&&n!==`End`)return;let r=t.findIndex(t=>S.current.get(t.id)===e.target);if(r===-1)return;let i=t.length,a=(e,n)=>{let r=e;for(let e=0;e<i;e+=1)if(r=(r+n+i)%i,!t[r].disabled)return r;return-1},o=-1;o=n===`ArrowDown`?a(r,1):n===`ArrowUp`?a(r,-1):n===`Home`?a(i-1,1):a(0,-1),o!==-1&&(e.preventDefault(),S.current.get(t[o].id)?.focus())},F={triggerPaddingBlock:m?.triggerPaddingBlock??`space.md`};m?.fontFamily&&(F.triggerFontFamily=m.fontFamily),m?.triggerFontSize&&(F.triggerFontSize=m.triggerFontSize),m?.triggerFontWeight&&(F.triggerFontWeight=m.triggerFontWeight);let I={};m?.divider&&(I.color=m.divider),m?.dividerWidth&&(I.thickness=m.dividerWidth);let L=Object.keys(I).length>0,R=m?.itemGap?{"--ds-accordion-item-gap":i(m.itemGap)}:void 0,z=[];return t.forEach((e,t)=>{s&&t>0&&z.push((0,g.jsx)(u,{overrides:L?I:void 0},`divider-${e.id}`)),z.push((0,g.jsx)(c,{ref:C(e.id),summary:e.summary,headingLevel:n,open:D.includes(e.id),disabled:e.disabled,keepMounted:l,overrides:F,onToggle:(t,n)=>N(e.id,t,n),children:e.content},e.id))}),(0,g.jsx)(`div`,{...x,ref:e,"data-ds":`Accordion`,"data-part":`list`,className:`ds-accordion`,style:R,onKeyDown:P,children:z})}var h,g,_;function v(){return(v=e((()=>{h=t(),r(),s(),l(),g=n(),_=typeof process<`u`&&!1,m.__docgenInfo={description:`Accordion — Design Schema, category: container.
...
}`,...P.parameters?.docs?.source},description:{story:`Present with three enabled triggers and nothing open, for the keyboard gate.`,...P.parameters?.docs?.description}}}})))()}I();export{M as Controlled,S as Default,N as DisabledItem,O as Faq,A as FormSections,C as HeadingLevel2,w as HeadingLevel3,T as HeadingLevel4,E as HeadingLevel5,D as HeadingLevel6,P as Keyboard,k as OneOpenAtATime,j as Undivided,F as __namedExportsOrder,x as default};