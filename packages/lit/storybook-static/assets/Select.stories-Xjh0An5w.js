import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{_ as t,r as n,t as r,w as i}from"./if-defined-CARySXJh.js";import{t as a}from"./Select-CR8lS8kO.js";var o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w;function T(){return(T=e((()=>{t(),r(),a(),o={title:`Select/Lit`,tags:[`autodocs`],parameters:{actions:{handles:[`change`,`open-change`]}},argTypes:{size:{control:`select`,options:[`sm`,`md`]},native:{control:`select`,options:[`auto`,`always`,`never`]},open:{control:`boolean`}},args:{label:`Country`,name:`country`,options:[{value:`ca`,label:`Canada`},{value:`fr`,label:`France`},{value:`jp`,label:`Japan`},{value:`us`,label:`United States`}],hideLabel:!1,size:`md`,multiple:!1,required:!1,disabled:!1,invalid:!1,native:`auto`},render:e=>i`
    <ds-select
      label=${e.label}
      name=${e.name}
      .options=${e.options}
