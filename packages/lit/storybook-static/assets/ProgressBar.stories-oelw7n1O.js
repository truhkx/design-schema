import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{_ as t,r as n,t as r,w as i}from"./if-defined-CARySXJh.js";import{t as a}from"./Stack-CZci_zJ9.js";import{t as o}from"./ProgressBar-Bp63zpQZ.js";var s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T;function E(){return(E=e((()=>{t(),r(),o(),a(),s={title:`ProgressBar/Lit`,tags:[`autodocs`],argTypes:{tone:{control:`select`,options:[`neutral`,`success`,`danger`]},announce:{control:`select`,options:[`none`,`milestones`,`complete`]},value:{control:{type:`range`,min:0,max:100,step:1}},showValue:{control:`boolean`},hideLabel:{control:`boolean`}},parameters:{actions:{handles:[]}},args:{label:`Uploading photos`,value:42,min:0,max:100,showValue:!0,hideLabel:!1,tone:`neutral`,announce:`complete`},render:e=>i`
    <ds-progress-bar
      label=${e.label}
      value=${n(e.value)}
      min=${e.min}
