import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{O as t,_ as n,a as r,b as i,f as a,g as o,h as s,i as c,o as l,p as u,u as d,v as f,w as p}from"./if-defined-CARySXJh.js";import{t as m}from"./Text-BrJPDVza.js";var h,g,_,v,y,b,x,S,C,w,T,E,D,O;function k(){return(k=e((()=>{o(),n(),l(),r(),m(),E={color:`--ds-divider-color`,thickness:`--ds-divider-thickness`,spacing:`--ds-divider-spacing`,labelSize:`--ds-divider-label-size`,labelGap:`--ds-divider-label-gap`,fontFamily:`--ds-divider-font-family`},D=[[`labelSize`,`fontSize`],[`fontFamily`,`fontFamily`]],new class extends u{static[class extends f{static{({e:[g,_,v,y,b,x,S,C,w,T],c:[O,h]}=s(this,[a(`ds-divider`)],[[d({type:String,reflect:!0}),1,`orientation`],[d({type:String}),1,`label`],[d({type:Boolean,reflect:!0}),1,`semantic`],[d({type:String,reflect:!0}),1,`spacing`],[d({attribute:!1}),1,`overrides`]],0,void 0,f))}#e=g(this,`horizontal`);get orientation(){return this.#e}set orientation(e){this.#e=e}#t=(_(this),v(this));get label(){return this.#t}set label(e){this.#t=e}#n=(y(this),b(this,!1));get semantic(){return this.#n}set semantic(e){this.#n=e}#r=(x(this),S(this,`none`));get spacing(){return this.#r}set spacing(e){this.#r=e}#i=(C(this),w(this));get overrides(){return this.#i}set overrides(e){this.#i=e}warnedLabel=void T(this);connectedCallback(){super.connectedCallback(),this.setAttribute(`data-ds`,`Divider`)}willUpdate(e){e.has(`overrides`)&&this.applyOverrides(),(e.has(`semantic`)||e.has(`label`)||e.has(`orientation`))&&this.syncSemantics(),(e.has(`label`)||e.has(`orientation`))&&this.warnIgnoredLabel()}get effectiveLabel(){return this.orientation===`vertical`?void 0:this.label||void 0}render(){let e=this.effectiveLabel;return e===void 0?i:p`
