...
}`,..._.parameters?.docs?.source},description:{story:"Controlled: `value` owns the open set, so a trigger reports `change` and waits for the consumer.",..._.parameters?.docs?.description}}},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
  args: {
    items: [...ITEMS, {
      id: 'support',
...
}`,...y.parameters?.docs?.source},description:{story:`Present with three enabled triggers and nothing open, for the keyboard gate.`,...y.parameters?.docs?.description}}}})))()}x();export{_ as Controlled,s as Default,v as DisabledItem,p as Faq,h as FormSections,c as HeadingLevel2,l as HeadingLevel3,u as HeadingLevel4,d as HeadingLevel5,f as HeadingLevel6,y as Keyboard,m as OneOpenAtATime,g as Undivided,b as __namedExportsOrder,o as default};