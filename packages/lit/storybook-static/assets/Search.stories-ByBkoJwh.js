import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{_ as t,r as n,t as r,w as i}from"./if-defined-CARySXJh.js";import{d as a}from"./iframe-C6sywzE2.js";var o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x;function S(){return(S=e((()=>{t(),r(),a(),o=[{value:`invoices-march`,label:`Invoices from March`},{value:`invoices-april`,label:`Invoices from April`},{value:`invoices-overdue`,label:`Overdue invoices`,description:`Past their due date`}],s={title:`Search/Lit`,tags:[`autodocs`],parameters:{actions:{handles:[`change`,`submit`,`clear`]}},argTypes:{size:{control:`select`,options:[`md`,`lg`]},showLabel:{control:`boolean`},loading:{control:`boolean`},landmark:{control:`boolean`},disabled:{control:`boolean`}},args:{label:`Search products`},render:e=>i`
    <ds-search
      label=${e.label}
  ...
  `},c={},l={args:{size:`md`}},u={args:{size:`lg`}},d={args:{label:`Search this site`,placeholder:`Search products and orders`}},f={args:{label:`Search orders`,showLabel:!0,size:`lg`}},p={args:{label:`Search products`,suggestions:[{value:`invoices-march`,label:`Invoices from March`},{value:`invoices-april`,label:`Invoices from April`}]}},m={args:{label:`Filter results`,landmark:!1,name:`filter`}},h={args:{defaultValue:`invoices`}},g={args:{disabled:!0,defaultValue:`invoices`}},_={args:{defaultValue:`invoices`,suggestions:[],loading:!0}},v={args:{defaultValue:`zzz`,suggestions:[]}},y={render:e=>i`
    ...
    ></ds-search>
  `},b={args:{defaultValue:`invoices`,suggestions:[{value:`invoices-march`,label:`Invoices from March`},{value:`invoices-april`,label:`Invoices from April`}]}},x=[`Default`,`SizeMd`,`SizeLg`,`HeaderSearch`,`SearchPageHero`,`WithSuggestions`,`FilterWithinAResultsPage`,`WithValue`,`Disabled`,`Loading`,`NoSuggestions`,`SuggestionsFromOnChange`,`Keyboard`],c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{}`,...c.parameters?.docs?.source}}},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  args: {
    size: 'md'
  }
