...
test.describe('Splitter (web) keyboard', () => {
  test.beforeEach(async ({ page }) => {
    ...
    await expect(page.getByRole('separator').first()).toBeVisible({ timeout: 15_000 });
  });
