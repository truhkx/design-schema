...
Gate: `python3 tools/generate.py --platform swiftui --component Button` (or the TS port) completes a round trip on the real workflow. Do not modify packages/*/src or generated/ except through the generator.
