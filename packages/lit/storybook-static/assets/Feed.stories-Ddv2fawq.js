import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{_ as t,w as n}from"./if-defined-CARySXJh.js";import{t as r}from"./Text-C3do0IPT.js";import{t as i}from"./Link-DBG2Lhp4.js";import{r as a}from"./iframe-DJFLK4ZL.js";function o(e){return new Date(Date.now()-e*6e4).toISOString()}var s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S;function C(){return(C=e((()=>{t(),a(),r(),i(),s={title:`Feed/Lit`,tags:[`autodocs`],parameters:{actions:{handles:[`load-more`,`show-new`,`item-visible`]}},argTypes:{headingLevel:{control:`select`,options:[`2`,`3`,`4`]},hasMore:{control:`boolean`},loading:{control:`boolean`},newItemsCount:{control:`number`},endMessage:{control:`text`}},args:{label:`Activity`,headingLevel:`3`,hasMore:!1,loading:!1,newItemsCount:void 0,endMessage:void 0,items:[{id:`evt-3`,heading:`Ana commented on Invoice 42`,timestamp:o(3),content:n`<ds-text size="sm">Looks right to me.</ds-text>`,actions:n`<ds-link href="#invoice-42">View invoice</ds-link>`,unread:!0},{id:`evt-47`,heading:`Bo approved Invoice 41`,timestamp:o(47),content:n`<ds-text size="sm">Approved for payment.</ds-text>`,actions:n`<ds-link href="#invoice-41">View invoice</ds-link>`},{id:`evt-95`,heading:`Dae opened a ticket`,timestamp:o(95),content:n`<ds-text size="sm">Export fails for large workspaces.</ds-text>`,actions:n`<ds-link href="#ticket-108">View ticket</ds-link>`}]},render:e=>n`
    <ds-feed
      label=${e.label}
