/**
 * Expander — behavior scenarios from the component doc, one test each, in the doc's order.
 * The doc (site/src/content/docs/components/disclosure.md) is the source of truth; the tests
 * gate runs this file after every generation round. See generated/prompts/Expander.web.md.
 */
...
import meta from './Expander.stories';
...
function setup(given: Partial<ExpanderProps> = {}) {
  ...
  const props = { ...meta.args, ...given, onToggle } as ComponentProps<typeof Expander>;
