import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{_ as t,r as n,t as r,w as i}from"./if-defined-CARySXJh.js";import{t as a}from"./Input-BhbKtdVo.js";var o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D;function O(){return(O=e((()=>{t(),r(),a(),o={title:`Input/Lit`,tags:[`autodocs`],parameters:{actions:{handles:[`change`,`focus`,`blur`]}},argTypes:{type:{control:`select`,options:[`text`,`email`,`password`,`number`,`search`,`tel`,`url`]},size:{control:`select`,options:[`sm`,`md`]},required:{control:`boolean`},hideLabel:{control:`boolean`},disabled:{control:`boolean`},invalid:{control:`boolean`}},args:{label:`Email address`,name:`email`},render:e=>i`
    <ds-input
      label=${e.label}
      name=${e.name}
      type=${n(e.type)}
