...
async function setup(given: Record<string, unknown> = {}) {
  ...
  const s = {
    ...
    props,
    root_: () => el,
    container: () => ((el.matches('[role="treegrid"]') ? el : null) ?? deep(root, '[role="treegrid"]') ?? (el.matches('[part~="container"], [data-part="container"]') ? el : null) ?? deep(root, '[part="container"]') ?? deep(root, '[data-part="container"]') ?? root.firstElementChild) as HTMLElement,
    ...
    expandButton: () => ((el.matches('[part~="expandButton"], [data-part="expandButton"]') ? el : null) ?? deep(root, '[part="expandButton"]') ?? deep(root, '[data-part="expandButton"]')) as HTMLElement,
...
describe('ds-tree-grid', () => {
  test('the-expand-button-expands-a-row', async () => {
    ...
    await userEvent.click(...(await pointerAt(activatable(s.expandButton(), s.el), s.expandButton())));
