...
- `ArrowUp` (Moves to the previous tab, wrapping.): expect focus-prev; given `orientation: "vertical"`; story URL `/iframe.html?id=tabs-lit--keyboard&viewMode=story&args=orientation:vertical`
