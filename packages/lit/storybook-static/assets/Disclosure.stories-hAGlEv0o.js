import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{_ as t,r as n,t as r,w as i}from"./if-defined-CARySXJh.js";import{t as a}from"./Disclosure-okTKhzAL.js";import{t as o}from"./Text-BrJPDVza.js";import{t as s}from"./Stack-CZci_zJ9.js";var c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C;function w(){return(w=e((()=>{t(),r(),a(),o(),s(),c={title:`Disclosure/Lit`,tags:[`autodocs`],parameters:{actions:{handles:[`toggle`]}},argTypes:{defaultOpen:{control:`boolean`},disabled:{control:`boolean`},keepMounted:{control:`boolean`},open:{control:`boolean`},headingLevel:{control:`select`,options:[void 0,`2`,`3`,`4`,`5`,`6`]}},args:{summary:`What happens if I cancel?`,children:`You keep access until the end of the current billing period. Your data is kept for 30 days after that, then deleted.`,defaultOpen:!1,disabled:!1,keepMounted:!1,open:void 0,headingLevel:void 0},decorators:[e=>i`<div style="max-inline-size: 32rem">${e()}</div>`],render:e=>i`
    <ds-disclosure
      summary=${e.summary}
  ...
  `},C=[`Default`,`HeadingLevel2`,`HeadingLevel3`,`HeadingLevel4`,`HeadingLevel5`,`HeadingLevel6`,`FaqAnswer`,`AdvancedOptions`,`OpenWithFormFields`,`Disabled`,`Open`,`Controlled`,`KeepMounted`,`Accordion`],l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{}`,...l.parameters?.docs?.source}}},u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`{
  args: {
    headingLevel: '2'
  }
