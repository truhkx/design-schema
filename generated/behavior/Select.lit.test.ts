...
describe('ds-select', () => {
  test('the-trigger-opens-the-popup', async () => {
    ...
    await userEvent.click(...(await pointerAt(activatable(s.trigger(), s.el), s.trigger())));
