...
component:
  ...
  styles:
    ...
    fontSize: { token: font.size.md, description: 'Body text. It reaches a string body directly; a body composed of Text or Link children keeps its own sizing, since a composite never restyles a child.' }
