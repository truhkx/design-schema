import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{_ as t,r as n,t as r,w as i}from"./if-defined-CARySXJh.js";import{A as a}from"./iframe-B0T1LYjz.js";var o,s,c,l,u,d,f,p,m,h,g,_,v,y,b;function x(){return(x=e((()=>{t(),r(),a(),o={title:`RadioGroup/Lit`,tags:[`autodocs`],parameters:{actions:{handles:[`change`]}},argTypes:{orientation:{control:`select`,options:[`vertical`,`horizontal`]},required:{control:`boolean`},invalid:{control:`boolean`},disabled:{control:`boolean`}},args:{label:`Shipping method`,name:`shipping`,options:[{value:`standard`,label:`Standard`,description:`Free, 3 to 5 business days`},{value:`express`,label:`Express`,description:`Next business day`},{value:`pickup`,label:`Pick up in store`,description:`Ready in 2 hours`}],value:void 0,defaultValue:void 0,orientation:`vertical`,required:!1,invalid:!1,disabled:!1,description:void 0,error:void 0},render:e=>i`
    <ds-radio-group
      label=${e.label}
      name=${e.name}
      .options=${e.options}
