import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{_ as t,r as n,t as r,w as i}from"./if-defined-CARySXJh.js";import{f as a}from"./iframe-CV6aZYyO.js";var o,s,c,l,u,d,f,p,m,h,g,_,v,y,b;function x(){return(x=e((()=>{t(),r(),a(),o=[{id:`shipping`,label:`Shipping address`},{id:`payment`,label:`Payment`},{id:`review`,label:`Review order`}],s={title:`Stepper/Lit`,component:`ds-stepper`,tags:[`autodocs`],parameters:{actions:{handles:[`step-select`]}},argTypes:{orientation:{control:`radio`,options:[`horizontal`,`vertical`]},navigable:{control:`radio`,options:[`none`,`completed`,`all`]},compact:{control:`boolean`}},args:{steps:[...o,{id:`confirm`,label:`Confirmation`}],current:`payment`},render:e=>i`
    <ds-stepper
      label=${n(e.label)}
      .steps=${e.steps}
      current=${e.current}
