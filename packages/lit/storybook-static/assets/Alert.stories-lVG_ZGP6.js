import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{_ as t,r as n,t as r,w as i}from"./if-defined-CARySXJh.js";import{t as a}from"./Link-EdDzPEMK.js";import{O as o}from"./iframe-CV6aZYyO.js";var s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C;function w(){return(w=e((()=>{t(),r(),o(),a(),s={title:`Alert/Lit`,tags:[`autodocs`],parameters:{actions:{handles:[`dismiss`]}},argTypes:{tone:{control:`select`,options:[`info`,`success`,`warning`,`danger`]},live:{control:`select`,options:[`status`,`alert`,`off`]},dismissible:{control:`boolean`},heading:{control:`text`},children:{control:`text`}},args:{tone:`info`,live:`status`,dismissible:!1,children:`Some features are unavailable while you are offline.`},render:e=>i`
