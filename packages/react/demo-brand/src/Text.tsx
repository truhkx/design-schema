...
const TONE_CLASS: Record<TextTone, string> = {
  default: 'demo-text--tone-default',
  strong: 'demo-text--tone-strong',
  muted: 'demo-text--tone-muted',
  danger: 'demo-text--tone-danger',
  onAction: 'demo-text--tone-on-action',
};
...
export function Text({
  ...
  const classes = [
    'demo-text',
    `demo-text--size-${size}`,
    `demo-text--weight-${weight}`,
    TONE_CLASS[tone],
    `demo-text--align-${align}`,
    truncate ? 'demo-text--truncate' : null,
    truncate && element === 'span' ? 'demo-text--truncate-inline' : null,
