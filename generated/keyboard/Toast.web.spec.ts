...
test.describe('Toast (web) keyboard', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('/iframe.html?id=toast-react--keyboard&viewMode=story');
  ...
  test('F6: Moves focus into the toast region (the first toast\'s action or dismiss button) from anywhere; F6 again returns to where focus was. (a toast is visible)', async ({ page }) => {
    const root = await subject(page, page.getByRole('status').first());
