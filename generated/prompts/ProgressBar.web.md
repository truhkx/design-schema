...
- aria-labelledby
- aria-busy
notes: "role=\"progressbar\" sits on the track <div>, with aria-labelledby (the label\
  \ Text's id), aria-valuenow/min/max and aria-valuetext from formatValue; data-ds\
  \ sits on the root wrapper, a plain container with no role \u2014 they are different\
