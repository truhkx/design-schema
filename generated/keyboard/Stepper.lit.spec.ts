...
test.describe('Stepper (lit) keyboard', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('/iframe.html?id=stepper-lit--keyboard&viewMode=story');
  ...
  test('Tab: Moves between navigable steps in order; non-navigable steps are not focusable.', async ({ page }) => {
    const root = await subject(page, page.getByRole('navigation').first());
