...
notes: "RN 0.73+ has role=\"meter\" (react-native-web renders role=meter; iOS/Android\
  ...
  \ before the width is known, on first layout and on resize. RN tests check the name\
  \ through accessibilityLabel and the visible text; accessibilityValue is not asserted\
  \ by the scenarios."
```
