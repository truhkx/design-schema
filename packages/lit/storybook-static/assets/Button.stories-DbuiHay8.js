...
}`,...T.parameters?.docs?.source},description:{story:`inverse: rendered on an inverse surface, like a Toast or a Tooltip-like panel. The surface is a\r
story-only decorator, so the meta's render (and the Lit code sample) stays the button itself.`,...T.parameters?.docs?.description}}},E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
  args: {
    track: 'signup',
    label: 'Sign up'
  }
