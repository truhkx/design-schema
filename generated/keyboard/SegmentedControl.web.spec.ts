// Generated by tools/keyboard_tests.ts from the `keyboard` block of the SegmentedControl doc. Do not edit.
...
test.describe('SegmentedControl (web) keyboard', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('/iframe.html?id=segmentedcontrol-react--keyboard&viewMode=story');
    await expect(page.getByRole('radiogroup').first()).toBeVisible({ timeout: 15_000 });
  });
  test('ArrowRight: Moves to and selects the next enabled segment, wrapping.', async ({ page }) => {
