...
notes: "Form-associated: setFormValue with the ISO string (a FormData with two entries\
  ...
  \ focuses its first focusable on open, so DatePicker moves focus to the selected\
  \ day (or today) after the popover has opened, and asks the popover to reposition\
