...
component:
  ...
  styles:
    ...
    minTarget: { token: size.target.comfortable, description: 'The hit area of each arrow''s controlSurface and the minimum block size of each tab; dots use `dotTarget`.' }
