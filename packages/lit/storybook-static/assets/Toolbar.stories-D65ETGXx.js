import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{_ as t,w as n}from"./if-defined-CARySXJh.js";import{t as r}from"./Button-DJvb7DFH.js";import{t as i}from"./Select-BpbEgFEz.js";import{h as a,u as o}from"./iframe-Dy0IL05G.js";var s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D,O;function k(){return(k=e((()=>{t(),o(),r(),a(),i(),s=e=>n`<ds-button variant="ghost" label=${e} overflow-label=${e}></ds-button>`,c=`Two labelled groups of three ghost text Buttons each: Text style (Bold, Italic, Underline) and Insert (Link, Image, Table)`,l={[c]:()=>n`
