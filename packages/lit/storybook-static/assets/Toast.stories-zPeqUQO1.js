import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{_ as t,r as n,t as r,w as i}from"./if-defined-CARySXJh.js";import{t as a}from"./Button-DJvb7DFH.js";import{S as o,b as s,x as c}from"./iframe-Dy0IL05G.js";var l,u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T;function E(){return(E=e((()=>{t(),r(),c(),a(),l={title:`Toast/Lit`,tags:[`autodocs`],parameters:{actions:{handles:[`action`,`dismiss`]}},argTypes:{tone:{control:`select`,options:[`neutral`,`success`,`warning`,`danger`]},duration:{control:`select`,options:[`short`,`long`,`persistent`]},dismissible:{control:`boolean`}},args:{message:`Message sent`,tone:`neutral`,dismissible:!0},beforeEach:()=>()=>s(),render:e=>i`
    <ds-toast
      message=${e.message}
      tone=${e.tone}
  ...
  \`
}`,...w.parameters?.docs?.source},description:{story:'The region with two persistent action toasts — four focusable buttons — and a focusable element\r\non each side of it, so `F6` has somewhere to come from and return to, and `Tab` somewhere to\r\nleave for.\r\n\nThe first is the toast the keyboard rules act on; the second is `danger`, so it announces through\r\n`role="alert"` rather than `status`. That keeps exactly one `role="status"` on the page: Escape\r\ndismisses the toast holding focus and only that one, which a `getByRole(\'status\')` locator can\r\nonly observe when no other status toast is left to take its place.',...w.parameters?.docs?.description}}}})))()}E();export{b as BackgroundResult,u as Default,g as DurationLong,_ as DurationPersistent,h as DurationShort,x as FailedUpload,C as Imperative,w as Keyboard,S as NotDismissible,y as Saved,m as ToneDanger,d as ToneNeutral,f as ToneSuccess,p as ToneWarning,v as UndoADelete,T as __namedExportsOrder,l as default};