import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{_ as t,w as n}from"./if-defined-CARySXJh.js";import{t as r}from"./Text-BrJPDVza.js";import{t as i}from"./Link-EdDzPEMK.js";var a,o,s,c,l,u,d,f,p;function m(){return(m=e((()=>{t(),i(),r(),a={title:`Link/Lit`,tags:[`autodocs`],parameters:{actions:{handles:[`click`]}},argTypes:{tone:{control:`select`,options:[`default`,`inherit`]},external:{control:`boolean`},download:{control:`boolean`}},args:{href:`/billing/history`,label:`View the billing history`,external:!1,tone:`default`,download:!1},render:e=>n`<ds-link
      href=${e.href}
      label=${e.label}
      tone=${e.tone}
      ?external=${e.external}
