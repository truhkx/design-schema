import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{_ as t,r as n,t as r,w as i}from"./if-defined-CARySXJh.js";import{t as a}from"./DatePicker-CyKs0umD.js";var o,s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C;function w(){return(w=e((()=>{t(),r(),a(),o={title:`DatePicker/Lit`,tags:[`autodocs`],parameters:{actions:{handles:[`change`,`open-change`]}},argTypes:{range:{control:`boolean`},open:{control:`boolean`},showWeekNumbers:{control:`boolean`},required:{control:`boolean`},hideLabel:{control:`boolean`},size:{control:`select`,options:[`sm`,`md`]},disabled:{control:`boolean`}},args:{label:`Due date`,name:`due`,range:!1,showWeekNumbers:!1,required:!1,hideLabel:!1,size:`md`,disabled:!1},render:e=>i`
    <ds-date-picker
      label=${e.label}
      name=${e.name}
      .value=${e.value}
