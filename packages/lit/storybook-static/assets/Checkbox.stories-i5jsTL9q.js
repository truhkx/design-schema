import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{_ as t,r as n,t as r,w as i}from"./if-defined-CARySXJh.js";import{t as a}from"./Stack-CZci_zJ9.js";import{t as o}from"./Checkbox-cHwY3d7l.js";var s,c,l,u,d,f,p,m,h,g,_,v,y,b,x,S,C;function w(){return(w=e((()=>{t(),r(),o(),a(),s={title:`Checkbox/Lit`,tags:[`autodocs`],parameters:{actions:{handles:[`change`]}},argTypes:{hideLabel:{control:`boolean`},checked:{control:`boolean`},defaultChecked:{control:`boolean`},indeterminate:{control:`boolean`},disabled:{control:`boolean`},required:{control:`boolean`},invalid:{control:`boolean`}},args:{label:`Send me product updates`,hideLabel:!1,name:`updates`,value:`on`,checked:void 0,defaultChecked:!1,indeterminate:!1,disabled:!1,required:!1,invalid:!1,description:void 0,error:void 0},render:e=>i`
    <ds-checkbox
      label=${e.label}
      name=${e.name}
      value=${e.value}
