// Generated by tools/keyboard_tests.ts from the `keyboard` block of the Select doc. Do not edit.
...
test.describe('Select (web) keyboard', () => {
  test.beforeEach(async ({ page }) => {
    await page.goto('/iframe.html?id=select-react--keyboard&viewMode=story');
    await expect(page.getByRole('combobox').first()).toBeVisible({ timeout: 15_000 });
  });
  test.skip('Enter: Opens the popup with the selected (or first) option active. (focus on trigger) — manual', async () => {});
  test.skip(' : Opens the popup with the selected (or first) option active. (focus on trigger) — manual', async () => {});
  test.skip('ArrowDown: Opens the popup with the selected (or first) option active. (focus on trigger) — manual', async () => {});
  test.skip('ArrowUp: Opens the popup with the selected (or first) option active. (focus on trigger) — manual', async () => {});
  test('Escape: Closes the popup without changing the value and returns focus to the trigger. (popup open)', async ({ page }) => {
    const root = await subject(page, page.getByRole('combobox').first());
  ...
  test.skip('End: As Listbox. (popup open) — manual', async () => {});
  test.skip('typeahead letter: As Listbox. (popup open) — manual', async () => {});
});
