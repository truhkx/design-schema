import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{O as t,T as n,_ as r,a as i,b as a,c as o,f as s,g as ee,h as te,i as ne,o as re,p as ie,u as c,v as l,w as u}from"./if-defined-CARySXJh.js";import{a as d,r as f}from"./directive-helpers-DkZg2Mgc.js";import{t as ae}from"./Text-b_nq3K9L.js";import{n as oe,r as se,t as ce}from"./directive-CZiujxgm.js";import{n as p,t as le}from"./class-map-C-hUkrHk.js";import{r as ue,t as m}from"./style-map-Dfwb0mxD.js";var h;function g(){return(g=e((()=>{n(),se(),f(),h=ce(class extends oe{constructor(){super(...arguments),this.key=a}render(e,t){return this.key=e,t}update(e,[t,n]){return t!==this.key&&(d(e),this.key=t),n}})})))()}function _(){return(_=e((()=>{g()})))()}function de(e,t){return e.replace(/\{(\w+)\}/g,(e,n)=>t[n]??e)}function v(e,t,n){return q.format(n>t?(e-t)/(n-t):0)}function y(e,t){return typeof e==`number`&&Number.isFinite(e)?e:t}function b(e){let t={};for(let n of Object.keys(e)){let r=e[n];r&&(t[n]=r)}return Object.keys(t).length>0?t:void 0}var x,S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q;function $(){return($=e((()=>{ee(),r(),re(),le(),_(),m(),i(),ae(),K={progress:`{label}: {value}`,complete:`{label}: complete`,indeterminate:`{label}: in progress`},q=new Intl.NumberFormat(void 0,{style:`percent`,maximumFractionDigits:0}),J=4,Y=new Set,X={fromAttribute(e){return e===null},toAttribute(e){return e?null:``}},Z={track:`--ds-progress-bar-track`,trackHeight:`--ds-progress-bar-track-height`,radius:`--ds-progress-bar-radius`,partGap:`--ds-progress-bar-part-gap`,labelGap:`--ds-progress-bar-label-gap`,transition:`--ds-progress-bar-transition`,indeterminateLoop:`--ds-progress-bar-indeterminate-loop`,indeterminateReducedOpacity:`--ds-progress-bar-indeterminate-reduced-opacity`,sweepEasing:`--ds-progress-bar-sweep-easing`},new class extends ie{static[class extends l{static{({e:[S,C,w,T,E,D,O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G],c:[Q,x]}=te(this,[s(`ds-progress-bar`)],[[c({type:String}),1,`label`],[c({type:Number}),1,`value`],[c({type:Number}),1,`min`],[c({type:Number}),1,`max`],[c({attribute:!1}),1,`formatValue`],[c({attribute:`hide-value`,reflect:!0,converter:X}),1,`showValue`],[c({type:Boolean,reflect:!0,attribute:`hide-label`}),1,`hideLabel`],[c({type:String,reflect:!0}),1,`tone`],[c({type:String,reflect:!0}),1,`announce`],[c({attribute:!1}),1,`overrides`],[o(),1,`liveMessage`],[o(),1,`liveSeq`]],0,void 0,l))}#e=S(this,``);get label(){return this.#e}set label(e){this.#e=e}#t=(C(this),w(this));get value(){return this.#t}set value(e){this.#t=e}#n=(T(this),E(this,0));get min(){return this.#n}set min(e){this.#n=e}#r=(D(this),O(this,100));get max(){return this.#r}set max(e){this.#r=e}#i=(k(this),A(this));get formatValue(){return this.#i}set formatValue(e){this.#i=e}#a=(j(this),M(this,!0));get showValue(){return this.#a}set showValue(e){this.#a=e}#o=(N(this),P(this,!1));get hideLabel(){return this.#o}set hideLabel(e){this.#o=e}#s=(F(this),I(this,`neutral`));get tone(){return this.#s}set tone(e){this.#s=e}#c=(L(this),R(this,`complete`));get announce(){return this.#c}set announce(e){this.#c=e}#l=(z(this),B(this));get overrides(){return this.#l}set overrides(e){this.#l=e}#u=(V(this),H(this,``));get liveMessage(){return this.#u}set liveMessage(e){this.#u=e}#d=(U(this),W(this,0));get liveSeq(){return this.#d}set liveSeq(e){this.#d=e}record=(G(this),{mounted:!1,indeterminate:!1,validRange:!1,tier:0,complete:!1});pendingMessage;frame=0;connectedCallback(){super.connectedCallback(),this.setAttribute(`data-ds`,`ProgressBar`),this.setAttribute(`role`,`progressbar`)}disconnectedCallback(){super.disconnectedCallback(),cancelAnimationFrame(this.frame)}get isIndeterminate(){return this.value===void 0||this.value===null}get bounds(){let e=y(this.min,0),t=y(this.max,100);return{min:e,max:t,valid:t>e}}get clampedValue(){let{min:e,max:t,valid:n}=this.bounds;return this.isIndeterminate||!n?e:Math.min(t,Math.max(e,y(this.value,e)))}get fraction(){let{min:e,max:t,valid:n}=this.bounds;return this.isIndeterminate||!n?0:(this.clampedValue-e)/(t-e)}get displayText(){let{min:e,max:t,valid:n}=this.bounds;return n?(this.formatValue??v)(this.clampedValue,e,t):v(e,e,t)}willUpdate(e){e.has(`overrides`)&&this.applyOverrides(),(!this.hasUpdated||e.has(`value`)||e.has(`min`)||e.has(`max`))&&this.updateAnnouncements()}firstUpdated(){let e=this.pendingMessage;e!==void 0&&(this.pendingMessage=void 0,this.frame=requestAnimationFrame(()=>this.emit(e)))}updated(){this.syncHostAria()}render(){let e=this.isIndeterminate,t=this.showValue&&!e,n=this.overrides,r=u`<ds-text
      part="label"
      data-part="label"
      element="span"
      size="sm"
    ...
    >`;return u`
      <div part="container" data-part="container">
        ...
        <div
          part="header"
          data-part="header"
          class=${p({"visually-hidden":this.hideLabel&&!t,"label-hidden":this.hideLabel&&t})}
        >
          <!-- Layout and the visually-hidden styles go on this wrapper, never on the label part. -->
          <span
            class=${p({"label-wrap":!0,"visually-hidden":this.hideLabel&&t})}
            >${r}</span
          >
          ${t?u`<ds-text
                part="valueText"
